...
const createEvent = () => {
    ...
    return (
        <Layout>
            <div className='text-4xl text-white font-bold flex justify-center my-10'>Create Event</div>
                ...
                <div className='w-[40%] bg-white/30 my-10 m-auto rounded-md shadow-lg shadow-black/50'>
                    <form
                        ...
                        <div className='flex justify-center mt-10'>
                            <CustomButton
                                className={`bg-[#E49318] text-white font-bold py-2 w-1/2 rounded-lg ${loading && "bg-orange-200 cursor-not-allowed"
                                    }`}
                                id="btn-create"
                                label="Create"
