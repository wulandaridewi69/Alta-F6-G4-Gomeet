...
- [ ] User can login
- [ ] User can see list of event
- [ ] User can see the detail of event
- [ ] User can join the event
- [ ] User can create, edit, delete event
- [ ] User can see the list self event and other event
- [ ] User can post and read comment each of event 
- [ ] User can edit and delete account
- [ ] User can view the history event
...
[@Irfan Halim](https://github.com/Irfanhlm)

[@Zaki Fauzi](https://github.com/zakifauzi)
